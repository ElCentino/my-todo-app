...
(0, _reactDom.render)(_react2.default.createElement(_Todo.Todo, null), document.getElementById('root-react'));
...
var Todo = exports.Todo = function (_Component) {
    ...
    function Todo(props) {
        ...
        _this.store = (0, _store2.default)(_initialState2.default);
        return _this;
    }
    ...
    _createClass(Todo, [{
        ...
        key: 'update',
        value: function update(i, note) {

            this.store.dispatch((0, _actions.editTodo)(note));
        ...
        value: function addNote() {
            ...
            this.store.dispatch((0, _actions.addTodo)('New Todo ' + (this.state.todos.length + 1)));
        ...
        value: function remove(i) {
            ...
            this.store.dispatch((0, _actions.removeTodo)(i));
        ...
        value: function clearTodos() {
            this.store.dispatch((0, _actions.clearTodos)([]));
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                null,
                React.createElement(_TopBar.TopBar, { listCount: this.state.todos.length, addNote: this.addNote.bind(this) }),
                React.createElement(
                    'ul',
                    null,
                    this.state.todos.map(function (todo, count) {
                        return React.createElement(_TodoItem.TodoItem, { todos: _this2.state.todos, key: todo.id, index: count, todo: todo.note, editMode: _this2.state.editMode, remove: _this2.remove.bind(_this2), update: _this2.update.bind(_this2), toggleEditMode: _this2.toggleEditMode.bind(_this2) });
                    })
                ),
                React.createElement(_ClearTodos.ClearTodos, { clear: this.clearTodos.bind(this), todos: this.state.todos })
            );
        }
    }]);
...
var _deleteForever = __webpack_require__(38);
...
exports.default = function (initialState) {
    ...
    return (0, _redux.applyMiddleware)(_reduxThunk2.default, logger)(_redux.createStore)(_reducers2.default, initialState);
};
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(44), __webpack_require__(45)(module)))
...
exports.editMode = exports.errors = exports.todos = undefined;
...
var editMode = exports.editMode = function editMode() {
    ...
    return action.type === _constants2.default.TOGGLE_EDIT_MODE ? !state : null;
};
...
module.exports = {"todos":[{"id":1,"note":"Get some Milk"},{"id":2,"note":"Get some Eggs"},{"id":3,"note":"Get some Bread"}],"editMode":false,"errors":[{"messsage":"Something went wrong"},{"messsage":"Something stopped working"}]}
