...
exports.removeError = exports.addError = exports.toggleEditMode = exports.clearTodos = exports.editTodo = exports.removeTodo = exports.addTodo = undefined;
...
var addTodo = exports.addTodo = function addTodo(note) {
...
var removeTodo = exports.removeTodo = function removeTodo(index) {
    ...
    return {
        type: _constants2.default.REMOVE_TODO,
        payload: index
    };
};

var editTodo = exports.editTodo = function editTodo(index, data) {

    return {
        type: _constants2.default.EDIT_TODO,
...
var clearTodos = exports.clearTodos = function clearTodos() {
    ...
    return {
        type: _constants2.default.CLEAR_TODO,
        payload: []
    };
};

var toggleEditMode = exports.toggleEditMode = function toggleEditMode(mode) {
    return function (dispatch, getState) {

        dispatch({
            type: _constants2.default.TOGGLE_EDIT_MODE
        });
    };
};
...
var addError = exports.addError = function addError(error) {
    ...
    return {
        type: _constants2.default.ADD_ERRORS,
        payload: {
            message: error
        }
    };
...
var removeError = exports.removeError = function removeError(index) {

    return {
        type: _constants2.default.REMOVE_ERROS,
        payload: index
    };
};
...
exports.default = function (initialState) {
    ...
    return (0, _redux.applyMiddleware)(_reduxThunk2.default, _reduxLogger2.default)(_redux.createStore)(_reducers2.default, initialState);
};
...
*/
var aa=__webpack_require__(4),ba=__webpack_require__(1),m=__webpack_require__(14),p=__webpack_require__(2),v=__webpack_require__(3),da=__webpack_require__(15),ea=__webpack_require__(16),fa=__webpack_require__(17),ha=__webpack_require__(5);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
        ...
        return {
                onAddTodo: function onAddTodo() {
                        ...
                        return dispatch((0, _actions.addTodo)("New Todo"));
                },
                onToggleEditMode: function onToggleEditMode() {

                        return dispatch((0, _actions.toggleEditMode)());
                },
                ...
                onClearTodos: function onClearTodos() {
                        ...
                        return dispatch((0, _actions.clearTodos)());
                },
                onEditTodo: function onEditTodo(index, todo) {

                        return dispatch((0, _actions.editTodo)(index, todo));
                }
        };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Todo.Todo);
...
var _ClearTodos = __webpack_require__(50);
    ...
    _createClass(Todo, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                null,
                React.createElement(_TopBar.TopBar, { listCount: this.props.todos.length, addNote: this.props.onAddTodo }),
                React.createElement(
                    'ul',
                    null,
                    this.props.todos.map(function (todo, count) {
                        return React.createElement(_TodoItem.TodoItem, { todos: _this2.props.todos, key: todo.id, index: count, todo: todo.note, editMode: _this2.props.editMode, remove: _this2.props.onRemoveTodo, update: _this2.props.onEditTodo, toggleEditMode: _this2.props.onToggleEditMode });
                    })
                ),
                React.createElement(_ClearTodos.ClearTodos, { clear: this.props.onClearTodos, todos: this.props.todos })
            );
        }
    }]);
...
var TopBar = exports.TopBar = function TopBar(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(_add2.default, { onClick: function onClick() {
                    addNote();
                } })
        )
    );
...
TopBar.propTypes = {
    listCount: function listCount(props) {
...
var _deleteForever = __webpack_require__(49);
...
var TodoItem = exports.TodoItem = function (_Component) {
    ...
    function TodoItem(props) {
        ...
        _this.SaveToStorage = _this.SaveToStorage.bind(_this);
        return _this;
    }
        ...
        value: function render() {
            ...
            if (this.state.editing) {
                ...
                return React.createElement(
                    'li',
                    { className: 'todo-item' },
                    React.createElement('input', { type: 'text', className: 'input-box', ref: 'inputdialog', defaultValue: this.refs.todotext.innerHTML }),
                    React.createElement(
                        'span',
                        { className: 'button-pane' },
                        React.createElement(_save2.default, { onClick: this.Save })
                    )
                );
            } else {
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            null,
                            ' ',
                            React.createElement(_edit2.default, { className: 'edit-pane', onClick: this.Edit }),
                            ' ',
                            React.createElement(_deleteForever2.default, { onClick: this.Remove, className: 'delete-pane' }),
                            ' '
                        )
                    )
                );
...
var ClearTodos = exports.ClearTodos = function ClearTodos(_ref) {
...
exports.saved = exports.editing = exports.editMode = exports.errors = exports.todos = undefined;
...
var todos = exports.todos = function todos() {
    ...
    switch (action.type) {
        ...
        case _constants2.default.EDIT_TODO:
            var arr = state.slice();
            arr[action.payload.index].note = action.payload.data;
            return arr;

        case _constants2.default.REMOVE_TODO:

            var temp = state.slice();
            temp.splice(action.payload, 1);
            return temp;

        case _constants2.default.CLEAR_TODO:
            return [];
...
var errors = exports.errors = function errors() {
    ...
    switch (action.type) {
        ...
        case _constants2.default.REMOVE_ERROS:
            return state.splice(action.payload);

        case _constants2.default.ADD_ERRORS:
            return [].concat(_toConsumableArray(state), [action.payload]);
...
var editMode = exports.editMode = function editMode() {
    ...
    switch (action.type) {
        ...
        case _constants2.default.TOGGLE_EDIT_MODE:
            return !state;
        default:
            return state;
    }
...
var editing = exports.editing = function editing() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    var action = arguments[1];
    ...
    switch (action.type) {
        ...
        case _constants2.default.EDITING:
            return !state;
        default:
            return state;
    }
...
var saved = exports.saved = function saved() {
    ...
    switch (action.type) {
        ...
        case _constants2.default.SAVED:
            return !state;
        default:
            return state;
    }
